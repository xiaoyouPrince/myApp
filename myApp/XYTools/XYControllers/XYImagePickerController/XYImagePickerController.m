...
+ (void)
presentImagePickerFromVC:(UIViewController *)controller sourceType:(UIImagePickerControllerSourceType)sourceType result:(void (^)(UIImage * _Nonnull, NSString * _Nonnull))result
{
